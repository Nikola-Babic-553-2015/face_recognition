...
class App(object):
    ...
    def run(self):
		...
		cv2.imwrite("slike1/frame"+str(time.time())+"sec.jpg", face)    #UPISUJE FREJM U FAJL		
...
if __name__ == '__main__':
    ...
    parser.add_option("-c", "--cascade", action="store", dest="cascade_filename", default="../../xml/haarcascade_frontalface_alt2.xml",
